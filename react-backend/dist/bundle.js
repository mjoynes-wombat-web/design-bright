...
var deprecate = __webpack_require__(74)('http-errors')
...
var getBody = __webpack_require__(112)
...
lazyProperty(module.exports, 'bufferConcat', function bufferConcat() {
  return Buffer.concat || __webpack_require__(75)
})
...
var _morgan = __webpack_require__(101);

var _morgan2 = _interopRequireDefault(_morgan);

var _dotenv = __webpack_require__(107);

var _dotenv2 = _interopRequireDefault(_dotenv);

var _cors = __webpack_require__(108);
...
var _campaigns = __webpack_require__(154);

var _campaigns2 = _interopRequireDefault(_campaigns);

var _advisor = __webpack_require__(155);

var _advisor2 = _interopRequireDefault(_advisor);

var _help = __webpack_require__(156);
...
var _dotenv$config$parsed = _dotenv2.default.config().parsed,
    _dotenv$config$parsed2 = _dotenv$config$parsed.PORT,
    PORT = _dotenv$config$parsed2 === undefined ? 3001 : _dotenv$config$parsed2,
...
var whitelist = ['http://192.168.86.200:3000'];
...
exports.static = __webpack_require__(100);
...
var eventListenerCount = __webpack_require__(43).eventListenerCount
var relative = __webpack_require__(1).relative
...
var mime = send.mime;
var resolve = path.resolve;
var vary = __webpack_require__(51);
...
var debug = __webpack_require__(103)('morgan')
var deprecate = __webpack_require__(2)('morgan')
var onFinished = __webpack_require__(7)
var onHeaders = __webpack_require__(106)
...
function loadParser (parserName) {
  ...
  switch (parserName) {
    ...
    case 'raw':
      ...
      break
    case 'text':
      parser = __webpack_require__(151)
      break
    case 'urlencoded':
...
var bomHandling = __webpack_require__(114),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(115); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(29).concat(__webpack_require__(54)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(55).concat(__webpack_require__(128)) },
...
module.exports = {
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(30).concat(__webpack_require__(56)) },
        gb18030: function() { return __webpack_require__(144) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(57).concat(__webpack_require__(146)) },
        encodeSkipVals: [0xa2cc],
    },
