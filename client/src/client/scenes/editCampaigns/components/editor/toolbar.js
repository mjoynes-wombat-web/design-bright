    ...
    <div className="toolbar">
      <div className="row align-justify">
        ...
        <div className="inline shrink columns">
          <button className="bold" type="button"onClick={e => props.onClickInline(e, 'bold')}>
            <span className="icon"></span>
          </button>
          <button className="italic" type="button" onClick={e => props.onClickInline(e, 'italic')}>
            <span className="icon"></span>
          </button>
          <button className="underlined" type="button" onClick={e => props.onClickInline(e, 'underlined')}>
            <span className="icon"></span>
          </button>
        </div>
        <div className="list-types shrink columns">
          <button className="numbered" type="button">
            <span className="icon"></span>
          </button>
          <button className="bullet" type="button">
            <span className="icon"></span>
          </button>
        </div>
        <div className="content-types shrink columns">
          <button className={`link${inlineType === 'link' ? ' active' : ''}`} onClick={props.onNewLink} type="button">
            <span className="icon"></span>
          </button>
